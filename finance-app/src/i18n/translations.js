export const translations = {
  uz: {
    ...
    income: "Kirim",
    expense: "Chiqim",
    recentTx: "So'nggi operatsiyalar",
    allTx: "Barchasi",
    activeDebts: "Faol qarzlar",
    myDebts: "Mening qarzim",
    theyOwe: "Menga qarzdorlar",
    familyBalance: "Oilaviy balans",
    ...
    alreadyInGroup: "Siz allaqachon bu guruhdasiz",
    removeBtn: "Chiqarish",
    changeRole: "Rolni o'zgartirish",
    categoriesTitle: "Kategoriyalar",
    addCategory: "Yangi kategoriya nomi...",
    resetDefault: "Standartga qaytarish",
    resetConfirm: "Barcha kategoriyalarni standartga qaytarasizmi?",
    deleteDefaultCat: "standart kategoriya. O'chirishni tasdiqlaysizmi?",
  ...
  ru: {
    ...
    usernameTaken: "Этот логин занят, выберите другой",
    ...
    addCategory: "Название новой категории...",
    resetDefault: "Сбросить к стандартным",
    resetConfirm: "Сбросить все категории к стандартным?",
    deleteDefaultCat: "стандартная категория. Подтвердить удаление?",
  ...
  en: {
    ...
    resetConfirm: "Reset all categories to defaults?",
    deleteDefaultCat: "is a default category. Confirm delete?",
